...
# is opt-in, while snooze, skip and pull-forward are on until someone turns them off.
_BOOL_OPTIONS = (
    OPTION_SYNC_PROBLEM_SENSORS,
    OPTION_ALLOW_SNOOZE,
    OPTION_ALLOW_SKIP,
...
def _empty_options() -> dict[str, Any]:
    ...
    ``allow_pull_forward`` default to **True**, so a document written before they
    ...
    return {
        ...
        OPTION_ALLOW_PULL_FORWARD: True,
